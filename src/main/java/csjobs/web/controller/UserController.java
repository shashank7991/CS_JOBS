...
public class UserController {
	...
	@RequestMapping(value = "/userverify.html")
	public String userverify(HttpSession session) {
		User user = userDao.getUserByUsername(User.getUser().getUsername());
	...
	public String reviewer(HttpSession session, ModelMap models) {
		...
		for (Job i : jobDao.getOpenJobs()) {
			if (i.getCommitteeMembers().contains(userDao.getUser(id))) {
				reviewerjobs.add(i);
			}
		}
